...
Your default host for MAMP PRO is `localhost`. The files for localhost are initially located in the `/Applications/MAMP/htdocs` folder. See the [Hosts](../Settings/Hosts) section for more information on what a host is and how to create additional hosts.
